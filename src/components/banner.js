export default function Banner(){
    return (
        <section className="relative w-full bg-main-pink pt-24 pb-12 px-4 flex flex-col items-center justify-center overflow-hidden shadow-md">
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                <h1 
                    className="text-text-espresso text-8xl md:text-9xl text-center leading-[0.8] p-10"
                    style={{ 
